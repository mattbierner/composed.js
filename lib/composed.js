...
var extractor = simpleCompose.bind(undefined, function(v) { return v[0]; });

var bundler = simpleCompose.bind(undefined, function(v) { return [v]; });
...
var composeReduceFactory = simpleCompose(bundler, wrapReduceFactory);

var composeReduceExplicitFactory = simpleCompose(bundler, wrapReduceExplicitFactory);
 ...
 * @return {function(...[*]): *} Composed function.
 */
var compose = simpleCompose(extractor, function(/*...*/) {
    return reduceFuncsRight(composeReduce, arguments);
});
 ...
 */
var composel = simpleCompose(extractor, function(/*...*/) {
    return reduceFuncsLeft(composeReduce, arguments);
});
